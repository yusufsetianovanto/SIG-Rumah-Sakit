                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="form-row">     
                                <div class="col">
                                    ...
                                    <input type="text" name="nama_rs" class="form-control" placeholder="Tambahkan Nama Rumah Sakit">
                                </div>
                                <div class="col">
                    ...
                    <?php
                        ...
                        if(isset($_POST['simpan']))
                        {
                            ...
                            $insert=mysqli_query($koneksi, "INSERT INTO datamap VALUES('','$nama_rs', '$alamat', '$latitude','$longitude')");
                            if($insert)
                            {
