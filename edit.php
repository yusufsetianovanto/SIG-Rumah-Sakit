                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="form-row">     
                                <div class="col">
                                    ...
                                    <input type="text" name="nama_rs" value="<?php echo $data['nama_rs']?>" class="form-control" placeholder="Tambahkan Nama Rumah Sakit">
                                </div>
                                <div class="col">
                    ...
                    <?php
                        ...
                        if(isset($_POST['simpan']))
                        {
                            ...
                            SET nama_rs='$nama_rs', alamat='$alamat', latitude='$latitude', longitude='$longitude'
                            WHERE id='$id'");
                            if($insert)
                            {
                                echo "<div align='center'><h5> Silahkan Tunggu, Data Sedang Disimpan...</h5></div>";
                                echo "<meta http-equiv='refresh' content='1;url=http://localhost/Web-gis/data.php'>";
                            }else{
                                echo "Gagal upload";
                            }
