...
<script type="text/javascript">
    ...
    function initialize(){
        ...
        <?php
          ...
          $query = $koneksi->query("SELECT * FROM datamap ORDER BY nama_rs ASC");
...
<div class="text-center" style="margin-bottom:0">
  ...
  <p><h1>Pendataan Rumah Sakit - Daerah Banjarmasin</h1></p>
</div>
          ...
          ?>
            <div class="text">
              <tr>
                ...
                <p><b><?php echo $no++; ?>. <?php echo $list['nama_rs']; ?></b></p>
